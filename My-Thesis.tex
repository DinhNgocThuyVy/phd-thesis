...
\begin{tcolorbox}[enhanced jigsaw, colframe=quarto-callout-important-color-frame, bottomrule=.15mm, titlerule=0mm, coltitle=black, bottomtitle=1mm, leftrule=.75mm, colbacktitle=quarto-callout-important-color!10!white, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Chapter Summary}, colback=white, opacitybacktitle=0.6, arc=.35mm, breakable, toprule=.15mm, left=2mm, opacityback=0, toptitle=1mm, rightrule=.15mm]
